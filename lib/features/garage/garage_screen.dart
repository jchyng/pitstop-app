...
class _OdometerSheetState extends State<_OdometerSheet> {
  ...
  Future<void> _save() async {
    final km =
        int.tryParse(_ctrl.text.trim().replaceAll(',', ''));
    if (km == null || km <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('올바른 주행거리를 입력해주세요')));
      return;
    }
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 36,
                  decoration: const BoxDecoration(
                      color: AppColors.chip, shape: BoxShape.circle),
          ...
          Align(
            ...
            child: Text('현재: ${_fmtKm(widget.current)} km',
                style: const TextStyle(
                    fontSize: 13,
                    color: AppColors.textTertiary,
                    fontFamily: AppText.fontFamily)),
